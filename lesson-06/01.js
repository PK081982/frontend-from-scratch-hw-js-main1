...
const WEB_TECH_IMAGES = [
  ...
  var countNumber=WEB_TECH_IMAGES.length;
  var numberElementArray=0;
  
  function myFunction(){
        
    numberElementArray--;
        if(numberElementArray=== -1)
      {
        numberElementArray=countNumber-1;
      }
  
        document.getElementById("web-tech-image").src= WEB_TECH_IMAGES[numberElementArray];
      }
  
      function myFunction1(){
        numberElementArray++;
        if(numberElementArray=== countNumber)
      {
